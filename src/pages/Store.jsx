...
export default function Store() {
  ...
  return (
    <div className="store-root" ref={containerRef}>
      ...
      <div style={{ background: '#1A1A1A', color: 'white', padding: '8px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', fontSize: '13px', flexWrap: 'wrap', gap: '8px' }}>
        {/* Left: Social Media Icons */}
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
          <span style={{ color: '#aaa', fontSize: '12px', marginRight: '4px' }}>FOLLOW US</span>
          <a href="https://www.facebook.com" target="_blank" rel="noreferrer" style={{ color: 'white', textDecoration: 'none', fontSize: '18px' }}>
