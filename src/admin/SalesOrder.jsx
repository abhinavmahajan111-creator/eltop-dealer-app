            ...
            <td style={{ ...s.td, textAlign: "center", verticalAlign: "bottom", paddingTop: 20 }}>
              ...
              <div style={{ position: "relative", height: 100, margin: "8px auto 0", width: 120 }}>
                <img
                  ...
                  alt="Company Stamp"
                  style={{ width: 110, height: 110, objectFit: "contain", position: "absolute", bottom: 0, left: "50%", transform: "translateX(-50%)", filter: "contrast(2.5) brightness(0.5) saturate(1.5)" }}
                />
              </div>
